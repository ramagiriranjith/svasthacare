...
const Services = () => {
  const services = [
    { icon: Scissors, title: "Cosmetic", description: "Enhance your appearance with safe and advanced cosmetic treatments.", features: ["Plastic Surgery", "Hair Transplant", "Skin Care"] },
